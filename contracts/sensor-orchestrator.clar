...
;; A decentralized sensor data management and orchestration platform on the Stacks blockchain
;; This contract manages sensor data listings, transfers, royalties, and trend tracking for 
;; IoT sensor data, enabling secure and transparent data marketplaces.
;; Error Constants
